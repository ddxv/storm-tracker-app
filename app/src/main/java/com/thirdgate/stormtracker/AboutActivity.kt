    ...
    fun AboutPage() {
        ...
        Column(
            ...
            Text(
                "github.com/ddxv/storm-tracker-app",
                fontSize = 20.sp,
                modifier = Modifier.clickable {
                    val intent =
                        Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/ddxv/storm-tracker-app"))
            ...
            Text(
                "github.com/ddxv/storm-tracker",
                fontSize = 20.sp,
                modifier = Modifier.clickable {
                    val intent =
                        Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/ddxv/storm-tracker"))
                    currentContext.value.startActivity(intent)
                }
            )
